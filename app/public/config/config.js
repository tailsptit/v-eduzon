...
var config =
{
	 ...
	 */
	autoMuteThreshold    : 4, //default 4, tails change to 2
	...
	// as speaker
	lastN                : 1, // default 4, tails change to 1
	mobileLastN          : 1,
	// Highest number of lastN the user can select manually in
	// userinteface
	maxLastN             : 3, // default 5, tails change to 3
	...
	logo                 : 'images/logo.veduzon.png', // default 'images/logo.example.png', tails change to 'images/logo.veduzon.png'
	title                : 'v-eduzon', // default 'edumeet', tails change to 'v-eduzon'
	// Service & Support URL
	// if not set then not displayed on the about modals
	supportUrl           : 'https://support.veduzon.com', // default 'https://support.example.com', tails change to 'https://support.veduzon.com'
