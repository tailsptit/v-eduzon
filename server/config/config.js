...
module.exports =
{
	...
	*/
	...
	turnAPIURI    : 'turn:numb.viagenie.ca', // default 'https://example.com/api/turn', tails change to 'turn:numb.viagenie.ca'
	turnAPIparams : {
		'uri_schema' 	: 'turn',
		'transport' 		: 'tcp',
		'ip_ver'    		: 'ipv4',
	...
	backupTurnServers : [
		{
			urls : [
				'turn:numb.viagenie.ca' // default 'turn:turn.example.com:443?transport=tcp', tails change to 'turn:numb.viagenie.ca'
			],
			username   : 'tails', // default 'example', tails change to 'tails'
			credential : 'example' // default 'example, tails change to '123456a@'
		}
	],
	// bittorrent tracker
